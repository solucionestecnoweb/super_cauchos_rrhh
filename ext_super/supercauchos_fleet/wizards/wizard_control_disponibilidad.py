...
class FlotaControlDisponibilidad(models.TransientModel):
    ...
    def generate_xls_report(self):
        ...
        ws1.write_merge(row,row, 2, (dates_data.day + 2), "Estadística de Disponibilidad de Vehículos en Viajes", header_content_style)
        ...
        self.write({'state': 'get', 'report': out, 'name':'Disponibilidad de Vehículos en Viajes '+ fecha +'.xls'})
        return {
