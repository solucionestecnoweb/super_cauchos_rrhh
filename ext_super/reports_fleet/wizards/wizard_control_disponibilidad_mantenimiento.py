...
class FlotaControlDisponibilidadMantenimiento(models.TransientModel):
    ...
    def print_ordenes(self):
        ...
        return {'type': 'ir.actions.report','report_name': 'reports_fleet.flota_control_disponibilidad_mantenimiento','report_type':"qweb-pdf"}
    ...
    def generate_xls_report(self):
        ...
        ws1.write_merge(row,row, 2, (dates_data.days + 1), "Estadística de Disponibilidad de Vehículos en Mantenimiento", header_content_style)
